...
* Private instance attribute: `size`:
	...
	* property setter `def size(self, value):` to set it:
		...
		* if `size` is less than `0`, raise a `ValueError` exception with the message s`ize must be >= 0`
...
#### Notes
* [Compare object instances for equality by their attributes](https://stackoverflow.com/questions/1227121/compare-object-instances-for-equality-by-their-attributes)
	* [Under](https://stackoverflow.com/a/1227152)
	* [python documentation](https://docs.python.org/3/reference/datamo_lt__)
